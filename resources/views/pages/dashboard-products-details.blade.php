                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="{{ url('images/products/pic1.jpg') }} " class="w-100" alt="">
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="{{ url('images/products/pic2.jpg') }} " class="w-100" alt="">
                                        <a href="#" class="delete-gallery">
                                            <img src="/images/remove.svg" alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="{{ url('images/products/pic3.jpg') }} " class="w-100" alt="">
                                        <a href="#" class="delete-gallery">
                                            <img src="/images/remove.svg" alt="">
                                        </a>
                                    </div>
