                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content mt-4" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="konsultasi" role="tabpanel" aria-labelledby="profile-tab">
                            <a href="#" class="btn btn-primary mb-4" data-toggle="modal" data-target="#modalkonsultasi">
                                Buat Konsultasi
                            </a>
                            <div class="table-responsive" style="margin-top: 40px;">
                                <table
                                    ...
                                    <tbody>
                                        @foreach ($konsultasi as $k => $item)
                                            <tr>
                                                ...
                                                <td width="10%">
                                                    <a href="{{ url('konsultasi') }}/{{ $item->id_konsultasi }}" class="btn btn-success">Detail</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
